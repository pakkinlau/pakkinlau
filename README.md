...
![1703358697810](image/README/prett-graph.png)
...
- [GPU-Environment-Windows-Linux-Docker](https://github.com/pakkinlau/GPU-Environment-Windows-Linux-Docker): When I first ventured into setting up a GPU-accelerated environment with CUDA and PyTorch, the process proved to be daunting and time-consuming. This was due to a couple of factors:
...
- [Multilingual-Semantic-Search-Course](https://github.com/pakkinlau/Multilingual-Semantic-Search-Course): Contextual embeddings generated by LLMs are the core technology used in semantic search. This short-course repository try to walk-through the environment setup, concepts involved, and also demonstrating some key steps of using those functions.

- [Big-Data-Integration-and-Processing-Course](https://github.com/pakkinlau/Big-Data-Integration-and-Processing-Course): This repository serves as a comprehensive guide to mastering big data techniques, featuring:
